...
```{r maps, echo=FALSE, out.width="100%"}
 ...
 map <- mapview(filter(sonde_locations, site_name == "USGS -  Joe Wright Res inflow"), layer.name = "Proposed JOEI",col.regions = "#34b1eb", cex = 8)+
  ...
  mapview(filter(sonde_locations, site_name == "CSU- Mountain Campus"), layer.name = " South Fork @ CSU Mtn Campus",col.regions = "black", cex = 8)+
      ...
      mapview(filter(sonde_locations, site_name == "Larimer - SF Poudre at Pingree Park Road"), layer.name = "Proposed SFM",col.regions = "orange1", cex = 8)+
  ...
  mapview(filter(sonde_locations, site_name == "Fort Collins -  Manner's Bridge"), layer.name = "Existing City of Fort Collins  Monitoring: Manner’s Bridge",col.regions = "#34ebba", cex = 8, alpha.regions = 1)+
    ...
    mapview(filter(sonde_locations, site_name == "Fort Collins -  Manner's Bridge"), layer.name = "Existing City of Fort Collins  Monitoring: Manner’s Bridge",col.regions = "#34ebba", cex = 8, alpha.regions = 1)+
        mapview(filter(sonde_locations, network == "Lower" & site_abbreviation %nin% c("SPRC", "BOXE")), layer.name = "Current Lower Network",col.regions = "blue", cex = 8)+
  mapview(filter(sonde_locations, network == "Lower" & site_abbreviation %in% c("SPRC", "BOXE")), layer.name = "Proposed Lower Network",col.regions = "green", cex = 8)
